...
if (function_exists('cs_get_option')):
    ...
    if (is_page()):        
        ...
        $et_transparent_menu = @$et_custom_page_options['et_transparent_menu'];
    endif;
endif;
?>
<!-- start header  -->
<header id="header1">
    <nav id="primary-menu" class="primary-menu <?php echo ($et_transparent_menu == '1') ? 'transparent-bg-menu menu-v1' : 'color-bg-menu menu-v1'; ?>">
