...
class WPBakeryShortCode_event_term_recent_news_2 extends WPBakeryShortCode {
    ...
    protected function content($atts, $content = null) {
        ...
        ob_start();
        event_term_recent_news_2($bg_image,$title,$sub_title,$post_limit,$el_class);
        return ob_get_clean();	         
    }
}

vc_map( array(
    "base"                  => "event_term_recent_news_2",
    "name"                  => esc_html__("Recent News 2", "event-term"),
    "class"                 => "",
