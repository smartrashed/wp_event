...
class WPBakeryShortCode_event_term_contact_us extends WPBakeryShortCode {
    ...
    protected function content($atts, $content = null) {
        ...
        ob_start();
        event_term_contact_us($title1,$title2,$title3,$description1,$description2,$description3,$icon_fontawesome1,$icon_fontawesome2,$icon_fontawesome3,$cf_title,$cf_shortcode,$el_class);
        return ob_get_clean();	         
    }
}

vc_map( array(
    "base"                  => "event_term_contact_us",
    "name"                  => esc_html__("Contact Us", "event-term"),
    "class"                 => "",
    ...
    "params" => array(        
        ...
        array(
            "type"              => "textfield",
            "heading"           => esc_html__("Contact Form Title:", "event-term"),
            "param_name"        => "cf_title",
            "group" => esc_html__("Contact Form", "event-term"),            
        ),
        array(
            "type"              => "textfield",
            "heading"           => esc_html__("Contact Form Shortcode:", "event-term"),
