...
class WPBakeryShortCode_event_term_testimonial extends WPBakeryShortCode {
    ...
    protected function content($atts, $content = null) {
        ...
        ob_start();
        event_term_testimonial($bg_image,$title,$sub_title,$post_limit,$el_class);
        return ob_get_clean();	         
    }
}

vc_map( array(
    "base"                  => "event_term_testimonial",
    "name"                  => esc_html__("Testimonial", "event-term"),
    "class"                 => "",
