...
class WPBakeryShortCode_event_term_schedule extends WPBakeryShortCode {
    ...
    protected function content($atts, $content = null) {
        ...
        ob_start();
        event_term_schedule($bg_image,$title,$sub_title,$el_class);
        return ob_get_clean();	         
    }
}

vc_map( array(
    "base"                  => "event_term_schedule",
    "name"                  => esc_html__("Event Schedule (Tab on Top)", "event-term"),
    "class"                 => "",
