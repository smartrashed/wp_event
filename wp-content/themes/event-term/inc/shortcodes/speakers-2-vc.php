...
class WPBakeryShortCode_event_term_speakers_2 extends WPBakeryShortCode {
    ...
    protected function content($atts, $content = null) {
        ...
        ob_start();
        event_term_speakers_2($title,$sub_title,$post_limit,$el_class);
        return ob_get_clean();	         
    }
}

vc_map( array(
    "base"                  => "event_term_speakers_2",
    "name"                  => esc_html__("Speakers Three Column", "event-term"),
    "class"                 => "",
