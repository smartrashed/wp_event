...
function event_term_schedule2($bg_image,$title,$sub_title,$el_class) {
    $bg_image = wp_get_attachment_image_src($bg_image, "full"); 
    ?>
    <section class="event-schedule homepage2 section-padding <?php echo esc_attr($el_class); ?>" <?php if (!empty($bg_image)): ?>style="background-image: url('<?php echo esc_url($bg_image[0]) ?>')"<?php endif; ?>>
        <div class="container">
            <div class="row">
                <div class="col-md-12">
