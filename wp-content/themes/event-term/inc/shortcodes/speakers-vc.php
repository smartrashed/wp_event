...
class WPBakeryShortCode_event_term_speakers extends WPBakeryShortCode {
    ...
    protected function content($atts, $content = null) {
        ...
        ob_start();
        event_term_speakers($title,$sub_title,$post_limit,$el_class);
        return ob_get_clean();	         
    }
}

vc_map( array(
    "base"                  => "event_term_speakers",
    "name"                  => esc_html__("Speakers Two Column", "event-term"),
    "class"                 => "",
