...
class WPBakeryShortCode_event_term_contact_form extends WPBakeryShortCode {
    ...
    protected function content($atts, $content = null) {
        ...
        ob_start();
        event_term_contact_form($bg_image,$title,$sub_title,$cf_shortcode,$el_class);
        return ob_get_clean();	         
    }
}

vc_map( array(
    "base"                  => "event_term_contact_form",
    "name"                  => esc_html__("Contact Form", "event-term"),
    "class"                 => "",
