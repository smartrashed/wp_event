...
class WPBakeryShortCode_event_term_speakers_1 extends WPBakeryShortCode {
    ...
    protected function content($atts, $content = null) {
        ...
        ob_start();
        event_term_speakers_1($title,$sub_title,$post_limit,$el_class);
        return ob_get_clean();	         
    }
}

vc_map( array(
    "base"                  => "event_term_speakers_1",
    "name"                  => esc_html__("Speakers Four Column", "event-term"),
    "class"                 => "",
