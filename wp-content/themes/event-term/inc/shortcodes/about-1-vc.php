...
class WPBakeryShortCode_event_term_about_1 extends WPBakeryShortCode {
    ...
    protected function content($atts, $content = null) {
        ...
        ob_start();
        event_term_about_1($title,$sub_title,$content,$buy_ticket_btn,$buy_ticket,$readmore_btn,$readmore,$event_info,$el_class);
        return ob_get_clean();	         
    }
}

vc_map( array(
    "base"                  => "event_term_about_1",
    "name"                  => esc_html__("About Style 1", "event-term"),
    "class"                 => "",
